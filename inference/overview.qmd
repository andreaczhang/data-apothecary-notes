...
In reality we *do not* observe both potential outcomes for an individual, since we only have ONE outcome. We observe $Y$ and $A$. For a population, average treatment effect (ATE) can be estimated.
