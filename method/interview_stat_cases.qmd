...
* QoL on ... Intervention: oral immunotherapy (Reier-Nilsen 2019)
* QoL, stigma stress scale (Simonsen 2023)


### Biomarker

* Artery blood flow measures. Intervention: ...  (Callender 2023)
...
* The ones I've done are mostly simple randomization
...
* Blinding: NA
* Sample size: a=0.05, b=0.8; effect size based on previous works, computed by advisee themselves
